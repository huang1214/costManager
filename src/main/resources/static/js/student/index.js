layui.define([ 'layer',  'table','common'], function (exports) {
    ...
    table.render({
        ...
        ,cols: [[ //表头
            ...
            ,{field: 'type', align:'center', title: '竞赛类别',unresize:true,templet: '<div>{{d.type.name}}</div>'}
            ,{field: 'proResource', align:'center', title: '项目预算',unresize:true}
            ,{field: 'moneyResource', align:'center', title: '申请报销',unresize:true}
            ,{title: '审核状态',templet: '#status',unresize:true,width:250}
