layui.define([ 'layer',  'table','common'], function (exports) {
    ...
    table.render({
        ...
        ,page: true //开启分页
        ,cols: [[ //表头
            {field: 'name', align:'center', title: '竞赛项目名',unresize:true}
            ,{field: 'genre', align:'center', title: '团队性质'}
            ,{field: 'type', align:'center', title: '竞赛项目类别',unresize:true,templet: '<div>{{d.type.name}}</div>'}
    ...
    exports('teacher/examine', datalist);
});