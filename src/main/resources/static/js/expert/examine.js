layui.define([ 'layer',  'table','common'], function (exports) {
    ...
    function createHtml(obj) {
        ...
        detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">凭证图片下载地址:</div><a href="'+data.book.downloadUrl+'">'+data.book.downloadUrl+'</a></br>';
        ...
        detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">教师工号:</div>'+data.teacher.num+'</br>';
        detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">教师姓名:</div>'+data.teacher.name+'</br>';
        detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">教师意见:</div>'+treason+'</br>';
        detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">审核员意见:</div>'+ereason+'</br>';
