...
<fieldset id="dataList" class="layui-elem-field layui-field-title sys-list-field">
    <legend style="text-align:center;">专家信息</legend>
    ...
    <div class="layui-field-box">
        <div id="dataContent">
            <table class="layui-hide" id="expertinfo" lay-filter="table"></table>
...
<script type="text/javascript">
    layui.define([ 'layer',  'table','form'], function (exports) {
        ...
        table.render({
            ...
            ,height: 'full-200'
            ,method:'GET'
            ,url: '/expert/list' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {type: 'checkbox', align:'center',unresize:true}
                ,{field: 'num', align:'center', title: '专家编号',unresize:true}
                ,{field: 'name', align:'center', title: '专家姓名',unresize:true}
        ...
        //     detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">指导专家工号:</div>'+data.teacher.num+'</br>';
        //     detailHtml += '<div class="layui-inline layui-word-aux" style="width: 150px">指导专家姓名:</div>'+data.teacher.name+'</br>';
